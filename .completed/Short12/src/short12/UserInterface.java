...
public class UserInterface {
    ...
    */  
    ...
    private final String octalValidator = "[0-7]{1,21}";
    private final String hexValidator = "[A-Fa-f0-9]{1,16}";
    ...
    private void displayOptionThree() {
        System.out.println("Decimal number is:" + strPro.hexToDec(enterAValue("Enter a hexadecimal number: ", hexValidator, "Only allow A-F and 0-9 (case insensitive, max 16 characters).")));
    }
    ...
    private void displayOptionTwo() {
        System.out.println("Decimal number is:" + strPro.octToDec(enterAValue("Enter a octal number: ", octalValidator, "Only allow 0-7. (Max 21 characters)")));
    }
